...
resource "azurerm_linux_function_app" "MISP-Func" {
  ...
  # Maybe think about using ~ zip_deploy_file 
  ...
  app_settings = {
    ...
    mispkey                                = "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx"
